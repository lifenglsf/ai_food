...
import (
	...
	v35 "spark/api/spark/v35"
	"spark/internal/service"
)

func (c *ControllerV35) Spark(ctx context.Context, req *v35.SparkReq) (res *v35.SparkRes, err error) {
	...
	er, val, qt, pt, ct, tt := service.Gen(name, "v3.5")
	if er != nil {
		res.Code = 100
